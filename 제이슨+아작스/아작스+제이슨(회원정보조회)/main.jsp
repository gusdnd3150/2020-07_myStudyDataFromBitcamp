<%@ page language="java" contentType="text/html; charset=UTF-8"
	import=" java.util.*,방명록.*" pageEncoding="UTF-8"
	isELIgnored="false"%>
...
<body>
	...
	<form method="get" enctype="multipart/form-data" action="guest_message" style="text-align:center;">
		<label for="name">이름 : </label><input type="text" name="name" id="guest_Name"><br>
		 ...
		 <input type= "hidden" name ="command" value ="guestms">
	</form>
		...
		<c:choose>
			...
			<c:when test="${list != null }">
				<c:forEach var="message" items="${messageList }">
					...
					<tr class="tr">
						<td><a href="${contextPath }/message/messageDelete.do?mId=${message.messageId}" class="btn delete">삭제하기</a></td>
