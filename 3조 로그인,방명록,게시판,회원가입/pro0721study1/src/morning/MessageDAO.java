...
public class MessageDAO {
	...
	public List<MessageVO> listMessages(int pageNum) {
	...
	public List<MessageVO> listMessages2(int id) {
	...
	public void addMessage(MessageVO m) {
		try {
			conn = dataFactory.getConnection();
	...
	public void editMessage(String name, String password, String message, int id) {
		try {
			conn = dataFactory.getConnection();
			System.out.println(message);
